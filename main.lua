...
local Cont = Instance.new("ScrollingFrame", M); Cont.Size = UDim2.new(1, -110, 1, -10); Cont.Position = UDim2.new(0, 105, 0, 5); Cont.BackgroundTransparency = 1; Cont.CanvasSize = UDim2.new(0, 0, 5, 0); Cont.ScrollBarThickness = 4
...
AddB("FLY HACK", Color3.fromRGB(50,50,50), function()
    local r = p.Character.HumanoidRootPart; local v = r:FindFirstChild("DH_Fly") or Instance.new("BodyVelocity", r); v.Name = "DH_Fly"; v.MaxForce = Vector3.new(9e9,9e9,9e9); v.Velocity = workspace.CurrentCamera.CFrame.LookVector * 60
end)
