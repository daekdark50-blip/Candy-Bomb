...
-- 1. ЭЛИТНАЯ МИНИМАЛИСТИЧНАЯ ЗАГРУЗКА
...
local tween = game:GetService("TweenService"):Create(barFill, TweenInfo.new(2, Enum.EasingStyle.Quart), {Size = UDim2.new(1, 0, 1, 0)})
tween:Play()
...
-- 2. AUTO CLICK ITEMS (НОВОЕ: МОЛОТ-ПУЛЕМЕТ)
MainTab:CreateToggle({
...
Rayfield:Notify({Title = "DARK SYSTEM", Content = "Overdrive Activated.", Duration = 3})
