...
local function CreateCandyHub()
    ...
    local function CreateP(name, vis)
        local f = Instance.new("ScrollingFrame", M); f.Size = UDim2.new(1, -130, 1, -20); f.Position = UDim2.new(0, 125, 0, 10); f.BackgroundTransparency = 1; f.Visible = vis; f.CanvasSize = UDim2.new(0, 0, 20, 0); f.ScrollBarThickness = 2
    ...
    -- ВКЛАДКА SCRIPTS
    AddB(P1, "1. Escape Tsunami", Color3.fromRGB(30,30,30), function() loadstring(game:HttpGet("https://raw.githubusercontent.com/osakaTP2/OsakaTP2/refs/heads/main/Escape%20Tsunami%20For%20BrainrotsDelta"))() end)
    AddB(P1, "2. Be a Lucky Block (FIX)", Color3.fromRGB(30,30,30), function() loadstring(game:HttpGet("https://raw.githubusercontent.com/gumanba/Scripts/main/BeALuckyBlock"))() end)

    -- ВКЛАДКА MY HUB
    AddB(P2, "SPEED (100)", Color3.fromRGB(30,30,30), function() p.Character.Humanoid.WalkSpeed = 100 end)
    AddB(P2, "ESP", Color3.fromRGB(30,30,30), function() for _, v in pairs(game.Players:GetPlayers()) do if v ~= p and v.Character then Instance.new("Highlight", v.Character) end end end)
